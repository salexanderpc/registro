...
function datosRecetaActivar($id_desc,$expediente) {
        ...
        $query_mostrar = "select  exp.numero_expediente,rec.id as id_medicamento,des.id as id_desc, des.fecha_programada,exp.id as id_expediente,
	...
	where exp.numero_expediente = '$expediente' and transaccion_id = 1 and des.id=$id_desc order by des.fecha_programada,id_desc,med.nombre_medicamento";

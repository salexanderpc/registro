...
--
-- Name: desc_recetas; Type: TABLE; Schema: public; Owner: atf; Tablespace: 
--
...
ALTER TABLE desc_recetas OWNER TO atf;

--
-- Name: desc_recetas_id_seq; Type: SEQUENCE; Schema: public; Owner: atf
--

CREATE SEQUENCE desc_recetas_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE desc_recetas_id_seq OWNER TO atf;

--
-- Name: desc_recetas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: atf
--

ALTER SEQUENCE desc_recetas_id_seq OWNED BY desc_recetas.id;
...
CREATE TABLE expediente (
    ...
    numero_expediente character varying(12)
);
...
--
-- Name: recetas_programadas; Type: TABLE; Schema: public; Owner: atf; Tablespace: 
--
...
ALTER TABLE recetas_programadas OWNER TO atf;

--
-- Name: recetas_programadas_id_seq; Type: SEQUENCE; Schema: public; Owner: atf
--

CREATE SEQUENCE recetas_programadas_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE recetas_programadas_id_seq OWNER TO atf;

--
-- Name: recetas_programadas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: atf
--

ALTER SEQUENCE recetas_programadas_id_seq OWNED BY recetas_programadas.id;


--
-- Name: transaccion; Type: TABLE; Schema: public; Owner: atf; Tablespace: 
--
...
ALTER TABLE transaccion OWNER TO atf;

--
-- Name: transaccion_id_seq; Type: SEQUENCE; Schema: public; Owner: atf
--
...
ALTER TABLE transaccion_id_seq OWNER TO atf;

--
-- Name: transaccion_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: atf
--
...
ALTER TABLE ONLY desc_recetas ALTER COLUMN id SET DEFAULT nextval('desc_recetas_id_seq'::regclass);
...
ALTER TABLE ONLY recetas_programadas ALTER COLUMN id SET DEFAULT nextval('recetas_programadas_id_seq'::regclass);
...
--
-- Data for Name: desc_recetas; Type: TABLE DATA; Schema: public; Owner: atf
--

COPY desc_recetas (id, transaccion_id, expediente_id, especialidades_id, medicos_id, fecha_programada) FROM stdin;
3	1	2	107	31	2020-02-02
4	1	3	100	58	2020-02-02
1	1	1	10	58	2012-02-02
2	1	1	10	58	2012-02-02
\.


--
-- Name: desc_recetas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: atf
--

SELECT pg_catalog.setval('desc_recetas_id_seq', 4, true);
...
--
-- Data for Name: recetas_programadas; Type: TABLE DATA; Schema: public; Owner: atf
--

COPY recetas_programadas (id, transaccion_id, desc_recetas_id, medicamento_id, cantidad, recepcion, despacho, fecha_retiro) FROM stdin;
5	2	3	43	10	f	f	2015-11-14 17:08:42
6	2	4	43	10	f	f	2015-11-14 18:09:07
1	2	1	43	90	f	f	2015-11-06 20:38:54
2	2	1	1	90	f	f	2015-11-06 20:38:54
3	2	2	43	45	f	f	2015-11-06 20:39:10
4	2	2	1	45	f	f	2015-11-06 20:39:10
\.


--
-- Name: recetas_programadas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: atf
--

SELECT pg_catalog.setval('recetas_programadas_id_seq', 6, true);


--
-- Data for Name: transaccion; Type: TABLE DATA; Schema: public; Owner: atf
--

COPY transaccion (id, tipo_transaccion) FROM stdin;
1	NO ACTIVADA
2	ACTIVADA EN RECEPCION
3	ACTIVADA EN DESPACHO
4	ACTIVADA EN ATF
5	ANULADA
6	PENDIENTE
7	FINALIZADA
...
--
-- Name: transaccion_id_seq; Type: SEQUENCE SET; Schema: public; Owner: atf
--

SELECT pg_catalog.setval('transaccion_id_seq', 7, true);


--
-- Name: desc_recetas_pkey; Type: CONSTRAINT; Schema: public; Owner: atf; Tablespace: 
--

ALTER TABLE ONLY desc_recetas
    ADD CONSTRAINT desc_recetas_pkey PRIMARY KEY (id);
...
--
-- Name: recetas_programadas_pkey; Type: CONSTRAINT; Schema: public; Owner: atf; Tablespace: 
--

ALTER TABLE ONLY recetas_programadas
    ADD CONSTRAINT recetas_programadas_pkey PRIMARY KEY (id);


--
-- Name: transaccion_pkey; Type: CONSTRAINT; Schema: public; Owner: atf; Tablespace: 
--
...
--
-- Name: desc_recetas_fkindex4; Type: INDEX; Schema: public; Owner: atf; Tablespace: 
--

CREATE INDEX desc_recetas_fkindex4 ON desc_recetas USING btree (transaccion_id);
...
CREATE INDEX ifk_rel_05 ON recetas_programadas USING btree (medicamento_id);


--
-- Name: ifk_rel_07; Type: INDEX; Schema: public; Owner: atf; Tablespace: 
--

CREATE INDEX ifk_rel_07 ON desc_recetas USING btree (medicos_id);


--
-- Name: ifk_rel_08; Type: INDEX; Schema: public; Owner: atf; Tablespace: 
--

CREATE INDEX ifk_rel_08 ON desc_recetas USING btree (especialidades_id);


--
-- Name: ifk_rel_09; Type: INDEX; Schema: public; Owner: atf; Tablespace: 
--

CREATE INDEX ifk_rel_09 ON desc_recetas USING btree (expediente_id);


--
-- Name: ifk_rel_10; Type: INDEX; Schema: public; Owner: atf; Tablespace: 
--

CREATE INDEX ifk_rel_10 ON recetas_programadas USING btree (desc_recetas_id);
...
CREATE INDEX recetas_fkindex2 ON recetas_programadas USING btree (desc_recetas_id);
...
CREATE INDEX recetas_fkindex3 ON recetas_programadas USING btree (medicamento_id);


--
-- Name: recetas_programadas_fkindex1; Type: INDEX; Schema: public; Owner: atf; Tablespace: 
--

CREATE INDEX recetas_programadas_fkindex1 ON desc_recetas USING btree (medicos_id);


--
-- Name: recetas_programadas_fkindex2; Type: INDEX; Schema: public; Owner: atf; Tablespace: 
--

CREATE INDEX recetas_programadas_fkindex2 ON desc_recetas USING btree (especialidades_id);


--
-- Name: recetas_programadas_fkindex3; Type: INDEX; Schema: public; Owner: atf; Tablespace: 
--

CREATE INDEX recetas_programadas_fkindex3 ON desc_recetas USING btree (expediente_id);


--
-- Name: desc_recetas_especialidades_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: atf
--

ALTER TABLE ONLY desc_recetas
    ADD CONSTRAINT desc_recetas_especialidades_id_fkey FOREIGN KEY (especialidades_id) REFERENCES especialidades(id);


--
-- Name: desc_recetas_expediente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: atf
--

ALTER TABLE ONLY desc_recetas
    ADD CONSTRAINT desc_recetas_expediente_id_fkey FOREIGN KEY (expediente_id) REFERENCES expediente(id);


--
-- Name: desc_recetas_medicos_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: atf
--

ALTER TABLE ONLY desc_recetas
    ADD CONSTRAINT desc_recetas_medicos_id_fkey FOREIGN KEY (medicos_id) REFERENCES medicos(id);


--
-- Name: desc_recetas_transaccion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: atf
--

ALTER TABLE ONLY desc_recetas
    ADD CONSTRAINT desc_recetas_transaccion_id_fkey FOREIGN KEY (transaccion_id) REFERENCES transaccion(id);
...
--
-- Name: recetas_programadas_desc_recetas_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: atf
--

ALTER TABLE ONLY recetas_programadas
    ADD CONSTRAINT recetas_programadas_desc_recetas_id_fkey FOREIGN KEY (desc_recetas_id) REFERENCES desc_recetas(id);


--
-- Name: recetas_programadas_medicamento_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: atf
--

ALTER TABLE ONLY recetas_programadas
    ADD CONSTRAINT recetas_programadas_medicamento_id_fkey FOREIGN KEY (medicamento_id) REFERENCES medicamento(id);


--
-- Name: recetas_programadas_transaccion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: atf
--

ALTER TABLE ONLY recetas_programadas
    ADD CONSTRAINT recetas_programadas_transaccion_id_fkey FOREIGN KEY (transaccion_id) REFERENCES transaccion(id);

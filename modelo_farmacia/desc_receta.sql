...
COPY desc_recetas (id, expediente_id, especialidades_id, medicos_id, fecha_programada) FROM stdin;
\.
...
SELECT pg_catalog.setval('desc_recetas_id_seq', 33, true);
...
SELECT pg_catalog.setval('expediente_id_seq', 9, true);
...
SELECT pg_catalog.setval('paciente_id_seq', 9, true);
...
SELECT pg_catalog.setval('recetas_programadas_id_seq', 36, true);
...
1	NO ACTIVADA
2	ACTIVADA RECEPCION
3	ENTREGADA DESPACHO
4	ANULADA
\.
...
SELECT pg_catalog.setval('transaccion_id_seq', 4, true);

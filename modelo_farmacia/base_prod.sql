...
SELECT pg_catalog.setval('desc_recetas_id_seq', 2, true);
...
3	3	2	43	45	f	f	2015-11-06 20:39:10
4	3	2	1	45	f	f	2015-11-06 20:39:10
1	6	1	43	90	f	f	2015-11-06 20:38:54
2	6	1	1	90	f	f	2015-11-06 20:38:54
\.
...
SELECT pg_catalog.setval('recetas_programadas_id_seq', 4, true);
...
SELECT pg_catalog.setval('transaccion_id_seq', 6, true);

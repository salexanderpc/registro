...
<html>
    <head>
        ...
        <script type="text/javascript" src="RegistroClinico.js"></script>
    ...
    <br>
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="../public/images/banner.png" class="img-responsive" alt="Responsive image">
            </div>
            <div class="col-md-3"></div>
        </div>
        <br><br>
  ...
  <div class="container">
    ...
    <p>
      El registro de Atencion se ha guardado correctamente
    </p>
  </div>
</div>
        </div>

...
while ($row = pg_fetch_array($resultado)) {
    ...
    $query_recetas = datosRecetaPaciente($id_des);
    ...
    $imp.= "<table class=\"table table-bordered \">
                                                    ...
                                                    <thead>
                                                        ...
                                                        <td bgcolor=\"\" class=\"success text-left\" colspan=\"4\"><button type=\"button\" onclick=\"ProcesarRecetaATF($id_des,$num_exp,1)\" class=\"btn btn-primary\"><i class=\"fa fa-share\"></i>&nbsp;&nbsp;Despachar</button></td>
                                                        <td class=\"success text-center\"colspan=\"1\">
                                                        <a href=\"duplicados.php?desc_receta=$id_des&numero_exp=$num_exp\" class=\"btn btn-success\" data-toggle=\"modal\" data-target=\"#myModal\"><i class=\"fa fa-retweet\"></i>&nbsp;&nbsp;Duplicados</a>                                           
                                                        </td>
                                                        <td class=\"success text-center\"colspan=\"1\">
                                                        <button type=\"button\" onclick=\"ProcesarReceta($id_des,$num_exp,2)\" class=\"btn btn-warning\">Anular Receta</button>
                                                        </td>
                                                        </tr>
                                                        <tr>
